 ...
 <head>
 	...
 	<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css"> <!-- Bootstrap -->
    ...
    <nav id='nav' class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            <div class='navbar-header'>
                <a class='navbar-brand' href='#'>Nizpott Store</a>
            </div>
   		...
   		<div class='carousel-inner' role='listbox'>
   		    <div id='carouselImage1' class='item active'>
   		        ...
   		        <div class="carousel-caption">
   		            <h1>Welcome to the technology of the future <php echo 'hola'; ?> </h1>
   		        </div>
 		 	</div>
 	...
 	<div id='iconos' class='container-fluid text-center'>          <!-- iconos -->
 	 <div class='row'>
 	        <div class='col-sm-4'>
 	                <h1 class="iconos"><span class="glyphicon glyphicon-off"></span></h1>
 	                <h3>POWER</h3><br>
 	                <p>We build one of the most powerfull software</p>
 	        </div>
 	        <div class='col-sm-4'>
 	...
 	<div id='company' class='container-fluid text-center'>
